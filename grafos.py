...
class Grafo:
    ...
    def agregar_vertice(self, vertice):
        ...
        lo añade con un conjunto de vecinos. """""
    ...
    def existe_arista(self, u, v):
        # Vertifica si ambos vertices existe y si 'v' esta en la lista de adyacencia de 'u'
...
print(f"Vecinos de Fin (dirigido): {grafo_dirigido.obtener_vecinos('Fin')}") # Deberia ser vacio
